...
```js
const notas = {'mates':7, 'lengua': 4}
notas['dibujo'] = 3
notas.religion = 5
const asignatura = 'sociales'
notas[asignatura] = 10
const conservatorio = {'piano':6, 'solfeo':7}
const notasTotales = {...notas,...conservatorio}
const notasTotalesJunio = {...notasTotales,'lengua':5,'dibujo':5}
console.log(notasTotalesJunio)
```
